...
if user_menu=='Overall Analysis':
    ...
    events_over_time=helper.data_over_time(df,'Event','No. of Athletes')
    fig=px.line(events_over_time,x="Edition",y='No. of Athletes')
    st.plotly_chart(fig)
...
if user_menu=='Country-wise Analysis':
    ...
    st.title(selected_country+" performance in every Sports")
...
if user_menu=='Athlete-wise Analysis':
    ...
    fig1=ff.create_distplot([x0,x1,x2,x3],['Age Distribution','Gold','Silver','Bronze'],show_hist=False,show_rug=False)
    # fig.update_layout(autosize=False,width=1000,height=600)
    fig1.update_layout(autosize=False,width=800,height=400,margin=dict(l=0, r=0, t=0, b=0))
